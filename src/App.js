    ...
    return (
      ...
      <Navs/>
        <div className="container">
          ...
          <div className="main" style={{backgroundImage: `url(${white})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center", backgroundColor: "", borderRadius: "15px", padding: "20px", border: "1px solid black"}}>
            <section> <a href="menu"> </a>
